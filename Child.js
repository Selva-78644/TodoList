...
function Child() {
  ...
  return (
    // <div className="App">
    <div class="container" style={{color:"blue", borderRadius:"25px",padding:"100px",height:"50vh",marginTop:"80px",marginLeft:"300px",width:"700px",justifyContent:"center",alignItems:"center"}}>
          ...
          <li key={index}>
            {editIndex === index ? (
              <>
                ...
                />
                <button onClick={() => handleEditSave(index)}style={{background:"yellow",width:"100px",marginLeft:"10px",borderRadius:"50px"}}>Save</button>
              </>
            ) : (
              <>
                {todo}
